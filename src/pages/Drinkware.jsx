...
const openWhatsApp = (product = "") => {
  const msg = product
    ...
    : "Hello, I want details about your Drinkware products."
...
const productSections = [
  {
    title: "Water Bottles",
    subtitle: "Custom printed bottles for every need",
    products: [
  ...
  },
  {
    ...
    subtitle: "Keep it hot or cold — all day long",
    products: [
  ...
  {
    title: "Ceramic Mugs",
    subtitle: "Custom printed mugs for gifting & branding",
    products: [
  ...
  return (
    <>
      ...
      <section className="relative w-full h-[50vh] min-h-[360px]">
        <img
          src="https://images.unsplash.com/photo-1514228742587-6b1558fcca3d?q=80&w=1400"
          alt="Drinkware"
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-8 md:px-20">
          ...
          <p className="text-white/80 text-sm md:text-base max-w-md mb-8">
            Custom printed bottles, tumblers, thermoses and mugs — perfect for corporate gifting, events & branding.
          </p>
          <button
      ...
      <div className="bg-zinc-50 border-b px-6 py-3 text-xs text-zinc-400">
        <span className="max-w-7xl mx-auto flex items-center gap-2">
          Home <span>/</span> <span className="text-zinc-700 font-medium">Drinkware</span>
        </span>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        <p className="text-zinc-600 text-sm leading-relaxed max-w-3xl">
          Explore our wide range of custom printed drinkware — from sublimation water bottles and stainless steel flasks to ceramic mugs and magic mugs. Perfect for corporate gifting, event merchandise, and personal branding. Order as low as single quantity.
        </p>
      </div>
