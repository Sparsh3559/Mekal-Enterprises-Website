...
const openWhatsApp = (product = "") => {
  const msg = product
    ? `Hello, I'm interested in ${product}. Please share details and pricing.`
    : "Hello, I want details about your Custom Apparel."
...
const productSections = [
  {
    title: "Polo T-Shirts",
    subtitle: "Premium collar tees for corporate & casual wear",
    products: [
  ...
  },
  {
    ...
    subtitle: "Everyday comfort in every fabric & weight",
    products: [
  ...
  },
  {
    ...
    subtitle: "Hoodies & sweatshirts for the cold season",
    products: [
  ...
  },
  {
    ...
    subtitle: "Performance wear for teams & tournaments",
    products: [
  ...
  {
    title: "Caps",
    subtitle: "Cotton & sporty caps with custom logo printing",
    products: [
...
function ProductCard({ name, image, tag }) {
  return (
    <div className="flex-shrink-0 w-56 group cursor-pointer" onClick={() => openWhatsApp(name)}>
      ...
      <p className="text-xs text-zinc-400 mt-0.5">Tap to enquire</p>
    </div>
  )
}
    ...
    <>
      ...
      <section className="relative w-full h-[50vh] min-h-[360px]">
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-8 md:px-20">
          ...
          <p className="text-white/80 text-sm md:text-base max-w-md mb-8">
            Premium quality custom clothing for brands, events, corporate teams & personal use.
          </p>
          <button
      ...
      <div className="bg-zinc-50 border-b px-6 py-3 text-xs text-zinc-400">
        <span className="max-w-7xl mx-auto flex items-center gap-2">
          Home <span>/</span> <span className="text-zinc-700 font-medium">Custom Apparel</span>
        </span>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        <p className="text-zinc-600 text-sm leading-relaxed max-w-3xl">
          Discover our wide range of customised clothing and apparel, perfect for every occasion. Our collection includes polo t-shirts, round neck tees, hoodies, jerseys, and caps — ensuring you find the ideal fit for corporate gifting, sports events, and everyday wear. Tailor your clothing with names, logos, and unique designs.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 mb-14">
        <div className="flex gap-6 overflow-x-auto pb-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          {categories.map((cat) => (
            <div key={cat.label} className="flex flex-col items-center gap-2 flex-shrink-0 cursor-pointer group">
      ...
      {/* ── Bottom CTA Banner ── */}
      <section className="mx-6 mb-16 rounded-3xl overflow-hidden relative" style={{ backgroundColor: "#065999" }}>
        <div className="px-10 py-14 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            ...
            <p className="text-white/70 text-sm">
              Tell us your requirements and we'll get back to you within 2 hours.
            </p>
          </div>
          <button
            onClick={() => openWhatsApp()}
